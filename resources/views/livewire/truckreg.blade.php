    ...
    <div class="modal" id="exampleModal"  tabindex="-1" role="dialog" style="display: block;">
        <div class="modal-dialog" role="document">
          <div class="modal-content" style="background-color: #a7ffa0;">
            ...
            {{!! session('message') !!}}
            <a class="btn btn-primary" href="{{route('auth-login-t')}} ">Okay</a>
    ...
    <div class="row setup-content {{ $currentStep != 3 ? 'displayNone' : '' }}" id="step-3">
        ...
        <div class="col-xs-12">
            <div class="row px-5">
                <div class="col-md-6">
                    <div class="form-group py-3">
                        <label class="form-label required" for="description">license_number :</label>
            ...
            <button class="btn btn-danger nextBtn btn-lg pull-right" type="button" wire:click="back(1)">Back</button>
            <button class="btn btn-primary nextBtn btn-lg pull-right" type="button" wire:click="sechalfStepSubmit">Next</button>
