                    ...
                    <div class="col-xs-12">
                      <div class="row px-5" >
                        ...
                        <div class="col-md-4" style="margin-top:0.9%;">
                          ...
                          <div class="form-group py-3 mt-2">
                        ...
                        <!-- Column for Email, Phone No, and Fax No -->
                        <div class="col-md-4">
                          <div class="form-group py-3">
                        ...
                        <!-- Column for Address, Zip Code, City, State, and Country -->
                        <div class="col-md-4">
                          <div class="form-group py-3">
                          ...
                          <div class="form-group py-3">
                            ...
                            <input type="number" oninput="this.value=this.value.slice(0,5)" maxlength="5" name="zip" class="form-control" id="zip" />
