                ...
                <div fxlayout="row" fxflex="100%" fxflex.xs="100%" fxflex.sm="100%"
                    ...
                    <div class="fuse-widget-front ng-tns-c268-42">
                        <div fxlayout="row wrap" fxlayoutalign="start"
                                                                        ...
                                                                        <div class="mat-form-field-flex ng-tns-c70-65">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <input autocomplete="off" matinput=""
                                                                                    value="@if(!empty($certPolicy->where('policy_type_id', $pt->id)->first())){{$certPolicy->where('policy_type_id', $pt->id)->first()->ADDL_INSR}}@endif" disabled=""
                                                                    ...
                                                                    <div class="mat-form-field-wrapper ng-tns-c70-65">
                                                                        <div class="mat-form-field-flex ng-tns-c70-65">
                                                                            ...
                                                                            <div
                                                                                class="mat-form-field-infix ng-tns-c70-65">
                                                                                <input autocomplete="off" matinput=""
                                                                                    value="@if(!empty($certPolicy->where('policy_type_id', $pt->id)->first())){{$certPolicy->where('policy_type_id', $pt->id)->first()->SUBR_WVD}}@endif" disabled=""
                                                                                    class="mat-input-element mat-form-field-autofill-control ng-tns-c70-65 cdk-text-field-autofill-monitored"
                                                                                    id="mat-input-21"
                                                                                    aria-invalid="false"
                                                                                    aria-required="false"><span
                                                            ...
                                                            <td colspan="7" style="padding: 10px;"
                                                                ...
                                                                <div style="font-size: 11px;" class="ng-tns-c268-42">
                                                                    ...
                                                                    <div class="form-floating form-floating-outline mb-4">
                                                                        <textarea class="form-control h-px-100" name="descrp" style="background-color: rgb(201 196 196 / 15%) !important;width: 100%;height: 90px;color: #000000;" placeholder="Comments here...">@if(!empty($certificate->descrp)){{$certificate->descrp}}@endif</textarea>
                                                                    ...
                                                                    <tbody class="ng-tns-c268-42">
                                                                        <tr class="ng-tns-c268-42">
                                                                            <td rowspan="2" width="50%"
                                                                                ...
                                                                                <textarea class="form-control h-px-100" required name="ch" style="background-color: rgb(201 196 196 / 15%) !important;width: 100%;height: 90px;color: #000000;" placeholder="Comments here...">@if(!empty($certificate->ch)){{$certificate->ch}}@endif</textarea>
                            ...
                            <div class="form-floating form-floating-outline mb-4">
                                <textarea class="form-control h-px-100" name="ars"  style="background-color: rgb(201 196 196 / 15%) !important;width: 100%;height: 290px;color: #000000;" placeholder="Comments here...">@if(!empty($certificate->ars)){{$certificate->ars}}@endif</textarea>
