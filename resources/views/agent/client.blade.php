                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group pb-3">
                                    ...
                                    <input type="text" class="form-control" id="modalCompanyName" name="user_name"
                                        value="" readonly>
                                </div>
                                <div class="form-group pb-3">
                                    <label for="userName">USDOT#</label>
                                    <input type="text" class="form-control" id="modalUsdotNumber" name="user_name"
                                        value="" readonly>
                                </div>
                                <div class="form-group pb-3">
                                    <label for="userName">Email:</label>
                                    <input type="text" class="form-control" id="modalEmail" name="user_name"
                                        value="" readonly>
                                </div>
                                <div class="form-group pb-4">
                                    <label for="userName">Address:</label>
                                    <input type="text" class="form-control" id="modalAddress" name="user_name"
                                        value="" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group pb-3">
                                    ...
                                    <input type="text" class="form-control" id="modalUserName" name="user_name"
                                        value="" readonly>
                                </div>
                                <div class="form-group pb-3">
                                    <label for="userName">Federal Registration No. (MC Number):</label>
                                    <input type="text" class="form-control" id="modalMcNumber" name="user_name"
                                        value="" readonly>
                                </div>
                                <div class="form-group pb-3">
                                    <label for="userName">Phone No:</label>
                                    <input type="text" class="form-control" id="modalCellNumber" name="user_name"
                                        value="" readonly>
                                </div>
                                <div class="form-group pb-4">
                                    <label for="userName">Address 2:</label>
                                    <input type="text" class="form-control" id="modalAddress2" name="user_name"
                                        value="" readonly>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group pb-3">
                                    ...
                                    <input type="text" class="form-control" id="zip" name="user_name"
                                        value="" readonly>
                                </div>
                                <div class="form-group pb-3">
                                    <label for="userName">City:</label>
                                    <input type="text" class="form-control" id="city" name="user_name"
                                        value="" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group pb-3">
                                    ...
                                    <input type="text" class="form-control" id="state" name="user_name"
                                        value="" readonly>
                                </div>
                                ...
                                <div class="form-group pb-3">
                                    ...
                                    <input type="text" class="form-control" id="modalContent" name="modalContent"
                                        value="" readonly>
                                </div>
            ...
            <div class="row g-0">
                <div class="col app-chat-contacts app-sidebar flex-grow-0 overflow-hidden " id="app-chat-contacts">
                    ...
                    <div class="sidebar-body ps ps--active-y">
                        ...
                        <ul class="list-unstyled chat-contact-list py-2" id="contact-list">
                            ...
                            @foreach ($driver as $data)
                                <li class="chat-contact-list-item ">
                                    <a class="align-items-center chat-contact-list-itemm temp"
                                        id="{{ $data->driver_id }}">
                                        <div class="chat-contact-info flex-grow-1 ms-4 ">
                                            ...
                                            <small
                                                class="chat-contact-status text-truncate ">{{ str_replace('_', ' ', $data->role) }}</small>
                                        </div>
                                    </a>
                                    ...
                                    <button class="btn primary " type="button" data-toggle="modal"
                                        ...
                                        data-company_name="{{ $data->name }}" data-cell_number="{{ $data->cellphone }}"
                                        data-address="{{ $data->address }}" data-address2="{{ $data->address2 }}"
                                        data-email="{{ $data->email }}" data-mc_number="{{ $data->mc_number }}"
                                        data-usdot_number="{{ $data->usdot }}" data-state="{{ $data->state }}"
                                        data-city="{{ $data->city }}" data-zip="{{ $data->zip }}"
                                        style="margin: 0;padding: 0px 0px;">

                                        <i class="mdi mdi-eye eye temp" style="    margin: 0; padding: .6rem .6rem;"></i>
                                    </button>
                                </li>
                                <li>
                        ...
                        <div class="ps__rail-y" style="top: 0px; height: 434px; right: 0px;">
                            <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 182px;">
                        ...
                        <table class="table dataTable collapsed chat-contact-list" id="contact-list"
                            ...
                            <thead>
                                <tr class="border-bottom">
                                    <th class="" rowspan="1" colspan="1" style="width: 18px;"
                                        data-col="1" aria-label=""></th>
                                    <th class="text-black" style="color: black !important;" tabindex="0"
                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                        style="width: 20px;" aria-label="order: activate to sort column ascending">
                                        Certificate ID</th>
                                    <th class="text-black " style="color: black !important;" tabindex="0"
                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                        style="width: 134px;" aria-label="date: activate to sort column descending"
                                        aria-sort="ascending">Download</th>
                                    <th class="text-black" style="color: black !important;" tabindex="0"
                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                        style="width: 101px;" aria-label="payment: activate to sort column ascending">View
                                        Certificate</th>
                                    <th class="text-black" style="color: black !important;" tabindex="0"
                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                        style="width: 118px;" aria-label="status: activate to sort column ascending">Edit
                                        Certificate</th>
                                    <th class="text-black" style="color: black !important;" tabindex="0"
                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                        style="width: 267px;" aria-label="customers: activate to sort column ascending">
                                        Add Certificate</th>
                                    <th class="text-black" style="color: black !important;" tabindex="0"
                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                        style="width: 147px;" aria-label="method: activate to sort column ascending">
                                        status</th>
                                    <th class="text-black" style="color: black !important;" tabindex="0"
                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                        style="width: 147px;" aria-label="method: activate to sort column ascending">
...
@section('page-scriptt')
        ...
        $(document).ready(function() {
            ...
            $('.chat-contact-list-itemm').click(function() {
                ...
                //     </tr>`;
                    ...
                    $.each(groupedPolicies, function(typeId, group) {
                        const firstPolicy = group.policies[
                            0]; // Only display the first policy's details

                        // Aaj ki date aur ek saal baad ki expiry date calculate karna
                        ...
                        // Expiry date check karna (1 month baqi hai ya nahi)
                        const oneMonthBeforeExpiry = new Date(firstPolicy.expiry_date);
                        oneMonthBeforeExpiry.setMonth(oneMonthBeforeExpiry.getMonth() - 1);
                        const showButton = today >= oneMonthBeforeExpiry;
                        ...
                        policyRows += `<tr>
                            ...
                            <td class="expiry-date">${formattedExpiryDate}</td>
                            <td>
                                ${showButton ? `<button class="update-policy btn btn-info" data-policy-id="${firstPolicy.id}">Renew</button>` : ''}
                            </td>
                        </tr>`;
                    });
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.length == 0) {
                            var newRow =
                                `<div class="d-flex align-items-center text-nowrap"><a target="_blank" href="cert_1st_step/ ${id}"><i class="mdi mdi-plus-box"></i>Add Certificate </a></div> `;
                            $('.tbody').append(newRow);
                        }
    ...
    <script>
        ...
        $(document).on('click', '.update-policy', function() {
            ...
            $.ajax({
                url: "{{ route('update.policy') }}", // Laravel route helper
                type: 'POST',
                headers: {
